...
\GalCriticalNote{W08-WV002}{\textbf{Status: documented editorial notation
normalization; not an 1897 error.} The 1897 edition uses the indices
$p,\nu$. Tannery's 1908 collation reports manuscript $p,n$ and attributes the
change to $p,\nu$ to Liouville. The 1897 notation is retained above; the
manuscript notation is recorded only as witness history. Evidence:
\texttt{WITNESS\_VARIANTS.md}, W08-WV002, and W08-E1908A.}

\GalCriticalNote{W08-WV003}{\textbf{Status: documented orthographic
normalization; not an 1897 error.} The 1897 edition prints
\emph{Bulletin de Férussac}; the 1908 collation reports the manuscript's
lowercase, unaccented form. The bibliographic form in the translated 1897 text
is preserved and the manuscript spelling is not imported. Evidence:
\texttt{WITNESS\_VARIANTS.md}, W08-WV003, and W08-E1908A.}
...
\GalCriticalNote{W08-PE001}{\textbf{Status: repaired; correct 1846 witness found, with no explicit erratum located.} The 1897 upper row duplicates $5$
and omits the projective point $4$. The corresponding 1846 publication
reads $\infty,1,3,4,5,9$, and exact enumeration verifies that corrected
partition
$\{\infty,0\},\{1,2\},\{3,6\},\{4,8\},\{5,10\},\{9,7\}$
and its order-$60$, index-$11$ stabilizer in
$\operatorname{PSL}(2,11)$, whose order is $660$. The 1897 value remains in the translation;
downstream use of the $p=11$ construction must apply the visibly stated
correction. Evidence: W08-PE001, POST-P13-A006, and the cited 1846 witness and
group certificates in the post-P13 return.}
...
\GalCriticalNote{W08-PE002}{\textbf{Status: proved editorial word error and transmission closed.} The 1897
witness prints ``equation,'' whereas the 1846 publication prints
``reduction'' and Tannery's 1908 collation reports the manuscript/Liouville
reading as ``reduction.'' The printed word is retained; with the attested
reading, the sentence says that this \emph{reduction} is impossible in
higher cases. Downstream interpretation must not attribute impossibility
to the equation's existence. Evidence: W08-PE002 and POST-P13-A007; the 1846
witness and Tannery's explicit 1908 collation are recorded in the returned
priority matrix.}
...
\GalCriticalNote{W08-WV001}{\textbf{Status: unresolved after bounded search, with the printed formula mathematically identified.}
The 1846 and 1897 relation $FE'+EF'-FF'=\pi/2$ is exactly Legendre's standard
relation under the source's $F/K$ notation. Tannery's 1908 collation reports a
materially different manuscript formula,
$F'F''-E''F'=(\pi/2)\sqrt{-1}$, whose double-prime notation cannot be
interpreted securely from the local evidence. The witnesses are not fused.
There is no downstream use in this volume, so this open reading blocks no later
claim. Evidence: W08-WV001, POST-P13-A008, DLMF 19.7.1, and
\texttt{OPEN\_AFTER\_21\_TASKS.csv}.}
