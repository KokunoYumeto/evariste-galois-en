...
\providecommand{\GalWitnessNote}[1]{%
  \par\begingroup\footnotesize\itshape\noindent [Witness note: #1]\par\endgroup}%
...
\end{center}
  \GalWitnessNote{\textbf{W01-U003 --- unresolved reading.} Two non-print manuscript strokes appear beneath ``GALOIS'' in the 1897 image. The publisher-device ribbon legend is retained graphically and is not expanded into uncertain text.}
\GalSourcePageEnd
...
{\Large E. GALOIS\par}
\end{center}
\GalWitnessNote{\textbf{W01-U001 --- unresolved reading.} The lower-right plate imprint reads ``Imp. Ch. Wittmann''. The faint lower-left plate signature is unresolved and is preserved only in the primary-image crop.}
\GalSourcePageEnd
...
\GalUnresolvedSourcePage{021}{L0020}{apparent_duplicate_portrait}{%
  ...
  {\Large E. GALOIS\par}
  \end{center}
  \GalWitnessNote{\textbf{W01-U002 --- unresolved topology.} This is a distinct physical scan page with the same printed caption and a severely degraded portrait field. Its relation to PDF 019 (second historical impression, duplicate plate, or digitization duplication) is not adjudicated; it must not be silently collapsed.}
  \GalSourcePageEnd
}
